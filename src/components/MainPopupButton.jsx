export default function MainPopupButton() {
  return (
    <div
      id="buttonGroup"
      className="flex flex-row w-full self-center absolute bottom-6 max-w-sm border rounded-xl bg-bright p-1 justify-evenly divide-x font-sans color-gunmetal text-xl " 
    >
